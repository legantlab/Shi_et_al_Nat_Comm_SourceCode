...
NA_max = 0.46;               % maximum NA of the annulus
NA_min = 0.36;               % minimum NA of the annulus
...
ny_step = 1;                % number of steps to simulate along the propagation direction
y_stepsize = 4;              % size of each step, unit in lambda

lattice_descrip = 'Hex';
PW =PW_Hex_Fund_MaxComp_1;
